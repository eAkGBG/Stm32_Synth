...
#define LV_USE_ASSERT_NULL          0//var 1   /**< Check if the parameter is NULL. (Very fast, recommended) */
#define LV_USE_ASSERT_MALLOC        0//var 1   /**< Checks is the memory is successfully allocated or no. (Very fast, recommended) */
