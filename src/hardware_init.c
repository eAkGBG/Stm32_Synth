...
void My_Hardware_Init(void) {
    ...
    //AUDIO I2S PIN MAPPING (PCM5100A)
    GPIO_InitStruct.Pin       = AUDIO_LCK_Pin | AUDIO_BCK_Pin | AUDIO_DIN_Pin;
    GPIO_InitStruct.Mode      = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull      = GPIO_NOPULL;
    GPIO_InitStruct.Speed     = GPIO_SPEED_FREQ_HIGH;
...
void Audio_Init(void)
{
    ...
    hdma_i2s2_tx.Init.PeriphDataAlignment = DMA_PDATAALIGN_HALFWORD; // 16-bit samples
...
void SystemClock_Config(void)
{
    ...
    PeriphClkInit.PLLI2S.PLLI2SN = 88;
